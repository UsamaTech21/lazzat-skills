# Menu ↔ Community Match

> **Rule:** Pair the right item with the right community moment. Never say "this item is FOR X community." Always frame: "this item pairs with [moment]."

---

## Pairing Logic

1. Identify the week's moment (festival / event / season).
2. Identify the community most connected to it.
3. Pull the item from `menu-v14.md` that naturally pairs.
4. Draft with global framing ("Every table, today's table is [moment]").
5. Run compliance → post.

---

## Master Pairing Table

| Community moment | Primary item (v14) | Secondary item | Caption angle | Pillar |
|---|---|---|---|---|
...
## Vegetarian / Vegan Anchor Items (for sensitive windows)

- **Paneer Cube** — all South-Asian vegetarian moments
- **Tofu Cube** — vegan anchor; Navratri, Lunar New Year, Buddha Purnima, wellness month
- **Veggie Seekh Kabab** — plant-based grill hero
...
## Global-Flavour Anchor Items (for cross-cultural moments)

- **Chicken Cube** — the universal centerpiece
- **Lamb Cube** — premium moments (Eid al-Adha, catering)
- **Prawn Cube** — Lunar New Year, Wellness pillar
- **Chicken Seekh Kabab** — grill-hero moments
- **Chapli Kabab** — grill-hero (never name the cuisine)
- **Shami Kabab** — grill-hero variant
...
|---|---|---|
| Lazzat Green | Cilantro-mint (pan-regional) | Default signature — hero every month |
...
| Honey Mustard | American / European | Thanksgiving, Christmas |
| Mango Chutney | South Asian (with care) | Vaisakhi (via mango), summer |
| Sweet Chili | South-East Asian | Lunar New Year, Filipino Independence |
| Garlic Aioli | Mediterranean / European | Valentine's, Mother's Day |
| Lemon Herb | Mediterranean / global | Wellness month, spring |

---

## Rules When Pairing

1. **One item + one community moment per post.** Don't stack three.
2. **Global framing always.** Never say "built for X community."
3. **Respect sensitivities.** During Navratri → no meat hero. During Ramadan day → no food imagery in daylight.
4. **Rotate.** Every community should be naturally featured at least once a month across the six pillars.
5. **Cross-pollinate.** A sauce from one heritage on a protein from another — that IS Lazzat. Celebrate the union.
