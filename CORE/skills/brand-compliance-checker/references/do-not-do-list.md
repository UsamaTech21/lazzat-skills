...
|---|---|---|
| Tandoori Chicken | Region-coded + implies tandoor | Lava stone Chicken Cube |
| Tikka | Region-coded | (none — use "Cube" / "Kabab") |
| Butter Chicken | Region-coded | (not on v14 — do not promise) |
| Biryani | Not on v14 | Saffron Rice Bowl |
| Karahi / Haleem / Nihari | Region-coded + not on v14 | (do not reference) |
| "Punjabi Kabab" | Regional | "Chicken Seekh Kabab" (menu v14) |
| "Indian sauce" | Regional | Name the actual sauce (e.g., "Lazzat Green") |
...
|---|---|---|
| "Charcoal-grilled" | Not our method | "Lava stone grilled" |
| "BBQ" | Generic + often region-coded | "Lava stone grill" |
| "Grilled over coals" | Implies charcoal | "Grilled over volcanic stone" |
| "Tandoor" / "tandoor-style" | Regional | "Lava stone" |
| "Oil-free" | Not accurate | "Low-oil" |
| "Zero-oil" | Not accurate | "Minimal oil" |
| "Farm-to-table" | Not documented | "Daily fresh prep" |
...
| "Fastest grill in Brampton" | Unproven | "Lava stone grill, Brampton" |
| "Served in minutes" | Not measured | *(omit timing)* |
| "Always fresh" | Absolute legal risk | "Daily fresh prep" |
| "Freshest in Brampton" | Unproven superlative | *(omit superlative)* |
| "Best in Brampton" | Unproven | "Brampton's lava stone grill" |
| "#1 halal restaurant" | Unproven | "Halal-sourced grill in Brampton" |
...
| "Dairy-free" | Not per-item verified | *(omit)* |

---

## 6. Religious / Certification
...
| "Halal-certified" | Certification not confirmed | "Halal-sourced" |
...
- "I hope this helps!"
- "Feel free to…"
- Em-dashes used as breath pauses in ad copy ("—") — we use periods or commas
