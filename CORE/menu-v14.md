...
## 1. FAMILY PLATTERS (Signature / Revenue Driver)

All platters: lava stone grilled, served with rice base, salad, sauces.

| Item | Serves | Notes |
|---|---|---|
| Lazzat Family Platter (Small) | 2–3 | Mixed grill selection |
| Lazzat Family Platter (Medium) | 3–4 | Mixed grill selection |
| Lazzat Family Platter (Large) | 4–6 | Mixed grill selection |
| Lazzat Mega Platter | 6–8 | Premium spread, catering-ready |

**Content Angle:** "Built for sharing. Built for every table."

---

## 2. BOWL BUILDERS (Core Lunch / Delivery)

### 2A. Pick a BASE (choose 1)
- Saffron Rice
- Cilantro Lime Rice
- Quinoa
- Lettuce Greens

### 2B. Pick a PROTEIN (choose 1)

**Cubes (lava stone grilled):**
- Chicken Cube
- Lamb Cube
- Beef-Free Steak Cube *(plant-based steak)*
- Prawn Cube
- Paneer Cube *(vegetarian)*
- Tofu Cube *(vegan)*

**Kababs (lava stone grilled):**
- Chicken Seekh Kabab
- Chapli Kabab *(lamb-based, NEVER marketed as "Pakistani")*
- Shami Kabab
...
**13 Signature Sauces:**
1. Lazzat Green (cilantro-mint)
2. Lazzat White (garlic yogurt)
3. Lazzat Red (smoky tomato)
4. Tahini
5. Tzatziki
6. Harissa (spicy)
7. Chipotle
...
- Mini Chicken Cube Bowl
- Mini Chicken Tenders (lava stone, not fried)
- Kids Veggie Bowl
- Includes juice box + small dessert
...
| Combo | Includes |
|---|---|
| Lazzat Solo | 1 Bowl + Drink |
| Lazzat Duo | 2 Bowls + 2 Drinks + Dessert to share |
| Lazzat Family Combo | Small Family Platter + 4 Drinks + 2 Sides |
| Office Combo (10–15 pax) | 2 Mega Platters + Drinks + Sides |
...
- Mango Madness
- Very Berry
- Green Glow (kale + apple + ginger)
- Tropical Sunrise

### 6B. Milkshakes (premium, Instagram-worthy presentation)
- Classic Chocolate
- Vanilla Dream
- Strawberry Cream
- Cookies & Cream
...
### 6D. Mocktails (no alcohol — brand rule)
- Virgin Mojito
- Passion Fruit Fizz
- Cucumber Cooler
- Berry Blast
...
- Baklava
- Chocolate Lava Cake
- Rice Pudding (cardamom-vanilla — NEVER called "kheer")
- Seasonal Fruit Bowl
...
- "13 signature sauces. One for every culture."
- "Lava stone grilled. Zero charcoal. Zero compromise."
- "From family platters to kids meals — every table welcome."
